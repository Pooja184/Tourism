      ...
      {showSuccess && (
        <div className="fixed inset-0 z-50 bg-black bg-opacity-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-xl shadow-xl p-6 max-w-md w-full">
            ...
            <div className="text-sm text-gray-700 space-y-2 border p-4 rounded-md">
              <p>
              ...
              <p>
                <span className="font-semibold">!</span> Ticket Check in Your
                Profile
              </p>
            </div>
            <button
              onClick={handleSuccessClose}
              className="mt-6 w-full bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-md"
            >
              Done
            </button>
          </div>
